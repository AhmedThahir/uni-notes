...
| Negative Binomial | $p=$ Probability of success after $(r-1)$ failures                                                                             | $f_x(x) = \begin{cases} \begin{pmatrix} x-1\\ r-1 \end{pmatrix} p^r q^{x-r}, & x= r, r+1, \dots  \\ 0, & \text{o.w.} \end{cases}$ |       $\dfrac{rq}{p}$        |                    $\dfrac{rq}{p^2}$<br><br>$\mu + \dfrac{\mu^2}{k}$                     |                       |
| Geometric         | Negative binomial dist with $r=1$<br />No of failures before first success                                                     |                                                                                                                                   |                              |                                                                                          |                       |
| Poisson           | 'Rare' discrete phenomenon in continuous interval<br><br>Poisson approximates Binomial when<br>- $p \to 0$<br>- $n \to \infty$ |                                               $\dfrac {e^{-\mu} \times \mu^x}{x!}$                                                |          $\alpha t$          |                                          $\mu$                                           | Counts, Rates<br>Risk |
