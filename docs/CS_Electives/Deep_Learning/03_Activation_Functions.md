...
|              Generalized Logistic               | $a + (b-a) \dfrac{1}{1+e^{-k(x-x_0)}}$<br><br>$a=$ minimum<br>$b=$ maximum<br>$k=$ steepness<br>$x_0 =$ $x$ center | Continuous          |      $[a, b]$       |      Depends on $a$ and $b$      |       ❌       | ❌ $\exp$ is computationally-expensive; though not significant in large networks<br>✅ Easy to interpret<br>- "probabilistic"<br>- saturating "firing rate" of neuron |
| Sigmoid/<br />Standard Logistic/<br />Soft Step |                                               $\dfrac{1}{1+e^{-x}}$                                                | Binary-Continuous   |      $[0, 1]$       |                                  |       ❌       | ❌ $\exp$ is computationally-expensive; though not significant in large networks<br>✅ Easy to interpret<br>- "probabilistic"<br>- saturating "firing rate" of neuron |
