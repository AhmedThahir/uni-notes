...
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| Random residuals                                             | - No relationship between error and independent variables<br />- No relationship between error and predictions<br/>- If there is correlation, $\exists$ unexplained system component                                                             | Normality test<br><br>Unexplained components<br>$r(a, b) = 0$<br>$\text{MI}(a, b) = 0$<br><br>Moments<br>$E(a \vert b) = 0$<br>$\sigma^2(a \vert b) = 1$<br>$\gamma_3(a \vert b) = 0$<br>$\gamma_4(a \vert b) \le 3$<br><br>$a \in [u, \vert u \vert , u^2, \log \vert u \vert]$<br><br>$b \in [ c, \vert c \vert , c^2, \log \vert c \vert]$<br>$c \in [x_j, y, \hat y]$ | Q-Q Plot<br>Histogram<br>Parallel coordinates plot<br><br>    | ❌ Unbiased parameters                                                                                                                                                                                                                                                                                                    | Fix model misspecification                                                                                         |
