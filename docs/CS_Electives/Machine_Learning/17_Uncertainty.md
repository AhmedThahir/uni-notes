...
| Delta Approach                 | $\begin{aligned} \dfrac{\hat \theta - \theta}{\widehat {\text{SE}}(\hat \theta)} \sim N(\mu, \sigma^2) \\ \implies \dfrac{f(\hat \theta) - f(\theta)}{f'(\hat \theta) \cdot  \widehat {\text{SE}} (\hat \theta)} \sim N(\mu, \sigma^2) \end{aligned}$ |                                                                                                       | ✅                    |                                                                                                                                                                 |
...
| Univariate Linear Regression<br>(Asymptotic Approach)                       | $\left\{ \text{RMSE} \sqrt{\dfrac{1}{n} + \dfrac{\bar x^2}{n \sigma^2_x}} , \dfrac{\text{RMSE}}{\sqrt{n\sigma^2_x} }\right\}$ | $\text{RMSE} \times \sqrt{\dfrac{1}{n} + \dfrac{(x_{i, \text{new}}- \bar x )^2}{n \sigma_x^2}}$                                           | $\text{RMSE} \times \sqrt{\dfrac{1}{n} + \dfrac{(x_{i, \text{new}} - \bar x )^2}{n \sigma_x^2} \ \textcolor{hotpink}{+ 1}}$ |
